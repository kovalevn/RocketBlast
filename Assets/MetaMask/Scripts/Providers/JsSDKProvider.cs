...
namespace MetaMask.Unity.Providers
{
    public class JsSDKProvider : BaseProvider
    {
        ...
        public static extern bool _InitMetaMaskJS(string dappName, string dappUrl, string dappIcon, 
            ...
            string walletCallback, string providerCallback, string errorCallback, string providerEventCallback, bool doJsConnect);
        ...
        public override void SendAnalytics(string eventId)
        {
            // NO OP: JS SDK will handle analytics tracking itself
        }
        #endregion
        ...
        public override void Connect(bool useConnectAndSign = false)
        {
            ...
            var eventCallback = JSCallback.Using<string>(OnEthereumEvent);
            ...
            _InitMetaMaskJS(_appConfig.AppName, _appConfig.AppUrl, _appConfig.AppIcon, 
                ...
                walletCallback, providerCallback, errorCallback, eventCallback, !useConnectAndSign);
        }
